<%-- 
    Document   : TambahRekamMedisAdmin
    Created on : Sep 3, 2019, 9:38:04 AM
    Author     : Acer
--%>
        ...
        <div>
            ...
            <div style=" float:left;height:500px; width: 60%;padding:20px;">
                <div style="background-color: #ddd; padding: 5%">
                    <form:form id="rekam" action="saveRekamMedisAdmin.htm" modelAttribute="rekamDto" method="POST">
                        ...
                        <form:hidden  path="id_dokter" id="idinp" />
                        <form:hidden  path="nama_pasien" id="nmpasien" />
                        <form:hidden  path="kode_poli" id="kdpol" />
...
//                }
                alert(data.kode_dokter);
                document.getElementById("idinp").value = data.kode_dokter;
                document.getElementById("nmpasien").value=data.kode_pasien;
                document.getElementById("kdpol").value=data.kode_poli;
            }
